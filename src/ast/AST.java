...
public abstract class AST {
    ...
    private static boolean allocateMemory;
    ...
    public static boolean isAllocateMemory() {
        return allocateMemory;
    }

    public static void setAllocateMemory(boolean allocateMemory) {
        AST.allocateMemory = allocateMemory;
    }
    ...
    protected static final void addVar(String varName) {
